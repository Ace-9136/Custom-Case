...
const DesignConfigurator = ({configId, imageUrl, imageDimensions}: DesignConfiguratorProps) => {
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20 ">
        <div ref={containerRef} className="relative justify-center h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
            <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
            <AspectRatio ref={phoneCaseRef} ratio={896/1831} className="relative z-50 w-full pointer-events-none aspect-[896/1831]">
            <NextImage alt="phone Image" fill src="/phone-template.png" className="pointer-events-none z-50 select-none"></NextImage>
            </ AspectRatio>
        ...
        <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white ">
          <ScrollArea className="relative flex-1 overflow-auto">
            <div aria-hidden="true" className="absolue z-10 inset-x-0 bottom-0 h-12 bg-gradient-to-t from-white pointer-events-none" />
